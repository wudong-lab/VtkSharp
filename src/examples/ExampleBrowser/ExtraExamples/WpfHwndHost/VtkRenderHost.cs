...
/// <summary>
/// Demonstrates hosting a native VTK render window in WPF.
/// This HwndHost-based approach is subject to WPF airspace limitations.
/// </summary>
internal sealed class VtkRenderHost : HwndHost
{
    ...
    protected override HandleRef BuildWindowCore(HandleRef hwndParent)
    {
        try
        {
            ...
            if (this._hostHandle == IntPtr.Zero)
                throw new Win32Exception("VTK did not create a Win32 render window.");
    ...
    private void InitializeVtk(nint parentHandle)
    {
        ...
        this.VtkRenderHostInitialized?.Invoke(
            this,
            new VtkRenderHostInitializedEventArgs(this.RenderWindow, this.Renderer, this.Interactor));
        this.UpdateHostSizeAndRender();
    }
...
internal sealed class VtkRenderHostInitializedEventArgs : EventArgs
{
