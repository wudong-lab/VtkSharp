...
VTKSHARP_API double* vtkProp3D_GetScale_(vtkProp3D* self) { return self->GetScale(); }

VTKSHARP_API void vtkProp3D_GetScale_doubleArray3(vtkProp3D* self, double* data) { self->GetScale(data); }
