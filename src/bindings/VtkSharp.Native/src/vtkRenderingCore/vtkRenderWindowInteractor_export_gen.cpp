...
VTKSHARP_API int vtkRenderWindowInteractor_CreateOneShotTimer(vtkRenderWindowInteractor* self, std::uint64_t duration) { return self->CreateOneShotTimer(static_cast<unsigned long>(duration)); }

VTKSHARP_API int vtkRenderWindowInteractor_CreateRepeatingTimer(vtkRenderWindowInteractor* self, std::uint64_t duration) { return self->CreateRepeatingTimer(static_cast<unsigned long>(duration)); }
