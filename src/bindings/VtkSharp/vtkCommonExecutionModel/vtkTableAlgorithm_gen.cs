...
public unsafe partial class vtkTableAlgorithm : vtkAlgorithm
{
    ...
    /// </remarks>
    public new static vtkTableAlgorithm New() => new(vtkTableAlgorithm_New(), ownsReference: true);
    /// <summary>
    ...
    /// </returns>
    public new static vtkTableAlgorithm FromBorrowedPointer(nint nativePointer) => new(nativePointer, ownsReference: false);
    /// <summary>
    ...
    /// </returns>
    public new static vtkTableAlgorithm TakeReference(nint nativePointer) => new(nativePointer, ownsReference: true);
    ...
    /// </returns>
    public new static vtkTableAlgorithm Register(vtkTableAlgorithm sourceObject)
    {
        var target = new vtkTableAlgorithm(sourceObject.NativePointer, true);
        target.Register();
        return target;
    }
