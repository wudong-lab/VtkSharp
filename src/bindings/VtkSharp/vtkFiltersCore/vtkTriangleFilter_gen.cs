...
public unsafe partial class vtkTriangleFilter : vtkPolyDataAlgorithm
{
    ...
    /// </remarks>
    public new static vtkTriangleFilter New() => new(vtkTriangleFilter_New(), ownsReference: true);
    /// <summary>
    ...
    /// </returns>
    public new static vtkTriangleFilter FromBorrowedPointer(nint nativePointer) => new(nativePointer, ownsReference: false);
    /// <summary>
    ...
    /// </returns>
    public new static vtkTriangleFilter TakeReference(nint nativePointer) => new(nativePointer, ownsReference: true);
    ...
    /// </returns>
    public new static vtkTriangleFilter Register(vtkTriangleFilter sourceObject)
    {
        var target = new vtkTriangleFilter(sourceObject.NativePointer, true);
        target.Register();
        return target;
    }
